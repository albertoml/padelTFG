...
class GroupTestInsert implements FixtureInterface
{
	public function load(ObjectManager $manager){
		...
		$Groups = array(
			...
			array('name' => 'Group C Test', 'category' => $category, 'tournament' => $tournament)
			);
		...
		$Inscriptions = array(
			...
			array('pair' => $pair6, 'tournament' => $tournament, 'category' => $category, 'group' => $groupC),
			array('pair' => $pair7, 'tournament' => $tournament, 'category' => $category, 'group' => $groupC),
			array('pair' => $pair8, 'tournament' => $tournament, 'category' => $category, 'group' => $groupC),
			array('pair' => $pair9, 'tournament' => $tournament, 'category' => $category, 'group' => $groupC),
			array('pair' => $pair10, 'tournament' => $tournament, 'category' => $category, 'group' => $groupC)
			);
